...
import type { ThemeResource } from "../../lib/services/resources.service";

interface ThemeSelectStepProps {
  themes: ThemeResource[] | undefined;
  selectedThemeId: string | null;
  onThemeSelect: (themeId: string) => void;
}

export function ThemeSelectStep({
  themes = [],
  selectedThemeId,
  onThemeSelect,
  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Choose a visual theme for the composition.</p>
      </div>
        ...
        {themes.map((theme) => {
          ...
          return (
            <div
              ...
              `}
            >
              <div className="absolute inset-0 bg-gray-100 rounded-xl overflow-hidden shadow-sm border border-gray-100">
                {theme.preview_url ? (
                  <img 
