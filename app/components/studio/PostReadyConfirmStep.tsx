...
interface PostReadyConfirmStepProps {
...
export function PostReadyConfirmStep({
  previewUrl,
  selectedModelImage,
  selectedThemeImage,
        ...
        <div className="lg:col-span-2 flex flex-col justify-center space-y-4 sm:space-y-6 lg:space-y-8 order-2 lg:order-1 pb-8 sm:pb-12 lg:pb-0">
          ...
          <div className="flex flex-wrap justify-center gap-6 pb-6 sm:pb-8 lg:pb-0">
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="relative w-40 h-56 bg-muted rounded-xl overflow-hidden shadow-md border border-border transition-transform hover:scale-105 ring-offset-2 ring-primary/20 hover:ring-2">
                {selectedModelImage ? (
                  <img src={selectedModelImage} alt="Model" className="w-full h-full object-cover object-top" />
                ) : (
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="relative w-40 h-56 bg-muted rounded-xl overflow-hidden shadow-md border border-border transition-transform hover:scale-105 ring-offset-2 ring-primary/20 hover:ring-2">
                {selectedThemeImage ? (
                  <img src={selectedThemeImage} alt="Theme" className="w-full h-full object-cover" />
                ) : (
                  <div className="w-full h-full flex items-center justify-center text-xs text-muted-foreground">None</div>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center text-sm font-semibold">
                  ...
                  <span className="text-primary">
                    {CREDITS_PER_GENERATION * imageCount} credits
                  </span>
                </div>
              </div>
            </div>
                ...
                {isGenerating ? (
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <div className="bg-white/20 px-2 py-0.5 rounded text-sm">
                      {CREDITS_PER_GENERATION * imageCount} c
                    </div>
                  </div>
                )}
              </button>
